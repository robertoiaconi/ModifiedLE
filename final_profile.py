...
ylabels = ['log$_{10}(P)$', 'log$_{10}(E_{int})$', 'log$_{10}(\\rho)$', 'log$_{10}(T)$']
...
axes[3].plot(s.radius, s.temperature, linestyle = '-')
axes[3].plot(full_profile.r, full_profile.temp, linestyle = '--')
